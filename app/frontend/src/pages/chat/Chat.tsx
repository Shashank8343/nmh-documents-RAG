...
// import nmIconLogo from 'src/assets/nm-icon-logo.png';
                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            {/* <img src={nmIconLogo} alt="Chat logo" style={{ width: "120px", height: "120px" }} aria-hidden="true" aria-label="Chat logo"></img> */}
                            {/* <SparkleFilled fontSize={"120px"} primaryFill={"rgba(115, 118, 225, 1)"} aria-hidden="true" aria-label="Chat logo" /> */}
                            <h1 className={styles.chatEmptyStateTitle}>Chat with our data</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Ask anything or try an example below</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. how long is a coaching program?)"
                            disabled={isLoading}
